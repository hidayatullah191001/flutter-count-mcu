                  ...
                  return pw.Container(
                    ...
                    child: pw.Row(
                      ...
                      children: [
                        ...
                        pw.Text(
                          'Jumlah Masuk : ${data[index]['total_masuk']}',
                          style: pw.TextStyle(font: ttf),
                        ),
                        pw.Text(
                          'Jumlah Keluar : ${data[index]['total_keluar']}',
                          style: pw.TextStyle(font: ttf),
                        ),
                      ],
                    ),
      ...
      body: SafeArea(
        ...
        child: BlocListener<CountBloc, CountState>(
          listener: (context, state) {
            if (state is DeleteCountSuccess) {
                  ...
                  builder: (BuildContext context, snapshot) {
                    ...
                    return ListView(
                      ...
                      children:
                        ...
                        CountModel count = CountModel.fromJson(
                            document.data() as Map<String, dynamic>);
                        return CardsTesPeserta(data: count);
                      }).toList(),
                    );
                  },
                ),
